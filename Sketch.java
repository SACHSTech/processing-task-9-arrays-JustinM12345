...
/**
 * @description Dodging Snow Flakes
 * @author Justin Mui
 */
public class Sketch extends PApplet {
  ...
  public void setup() {
    ...
    for (int intSnowFlake = 0; intSnowFlake < fltSnowX.length; intSnowFlake++) {
      ...
      ellipse(fltSnowX[intSnowFlake], fltSnowY[intSnowFlake], fltSnowDiameter[intSnowFlake], fltSnowDiameter[intSnowFlake]);
    }
    intPlayerX = width / 2;
    intPlayerY = 350;
  }
  ...
  public void snow() {
    fill(255);
    for (int intSnowFlake = 0; intSnowFlake < fltSnowX.length; intSnowFlake++) {
      ellipse(fltSnowX[intSnowFlake], fltSnowY[intSnowFlake], fltSnowDiameter[intSnowFlake] / 2, fltSnowDiameter[intSnowFlake] / 2);
  ...
  public void drawLives() {
    for (int intDrawnLives = 0; intDrawnLives < intLives; intDrawnLives++) {
      fill(255, 0, 0);
      rect((float) 25 * intDrawnLives + 20, (float) 20, (float) 20, (float) 20);
    }
  }
